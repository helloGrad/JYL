								...
								<div class="dropdown">
									...
									<form class="dropdown-menu">
										<ul class="inner-td">
											...
											</label> <label for="sche2" class="sche-item" id="SCHE00002">
													<input type="checkbox" name="" id="sche2" value="SCHE00002"
													onclick="changeClass(this);">교육
											</label> <label for="sche3" class="sche-item" id="SCHE00003">
													<input type="checkbox" name="" id="sche3" value="SCHE00003"
													onclick="changeClass(this);">세미나
											</label> <label for="sche4" class="sche-item" id="SCHE00004">
													<input type="checkbox" name="" id="sche4" value="SCHE00004"
													onclick="changeClass(this);">공고
											</label> <label for="sche5" class="sche-item" id="SCHE00005">
													<input type="checkbox" name="" id="sche5" value="SCHE00005"
													onclick="changeClass(this);">공고
											</label> <label for="sche6" class="sche-item" id="SCHE00006">
													<input type="checkbox" name="" id="sche6" value="SCHE00006"
													onclick="changeClass(this);">공고
											</label></li>
											...
											<li class="dropdown-li"><h5>학위</h5> <label for="de1"
												...
												class="de-item" id="DE00002"><input type="checkbox"
													name="" id="de2" value="DE00002"
													onclick="changeClass(this);">박사</label> <label for="de3"
												class="de-item" id="DE00003"><input type="checkbox"
													name="" id="de3" value="DE00003"
