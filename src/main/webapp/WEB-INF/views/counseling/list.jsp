...
<script type="text/javascript">
	...
	function counselinginsert() {
		...
		var writrInfoOpngYn = $(
				"input[type=radio][name=writrInfoOpngYn]:checked").val();
			...
			<div class="col-lg-9">
				...
				<div class="w3-container">
					...
					<div class="dropdown option">
						<button class="w3-button w3-padding w3-padding w3-round-large"
					...
					<div id="myModal" class="modal">
						...
						<div id="modal-content" class="modal-content">
							...
							<form class="counseling-form" id="counseling-form"
								name="counseling-form" onsubmit="counselinginsert();">

								<input type="hidden" id="authUser" name="authUser"
									value="${authUser.mbNo }"> 진로게시판 입력<input type="hidden"
									id="bbsNo" name="bbsNo" value="1"> 제목 : <input
									type="text" class="form-control" id="wrtbtTitle"
									name="wrtbtTitle"> 내용 :
								<textarea class="form-control" onkeydown="resize(this)"
									onkeyup="resize(this)" id="wrtbtText" name="wrtbtText"></textarea>

								작성자정보공개여부 : <input type="radio" id="writrInfoOpngYn"
									name="writrInfoOpngYn" value="Y" checked="checked" />Y <input
									type="radio" id="writrInfoOpngYn" name="writrInfoOpngYn"
									value="N" />N <br> 상담구분 : <select name="conslBbsDstnct"
									id="conslBbsDstnct">
								...
								<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
									<div class="design">
										<a href="#">Franchisee </a> |<a target="_blank"
											href="http://www.webenlance.com">Web Design & Development
											by Webenlance</a>
									</div>
								</div>
							</div>
				...
				<script type="text/javascript"
					src="${pageContext.request.contextPath}/resources/js/counselinglist.js"></script>
</body>
</html>